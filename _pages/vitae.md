...
<div class="row">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/VITAE_Tayrona1.JPG" title="Gatherings in Biosemiotics in Rotterdam" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
